          ...
          <div class="ctrlqFormContent">
            ...
            <form action="CustomerRegisterServlet" method="get">  
              ...
              <div class="row">
               ...
               <div class="row">
                <div class="input-field col s12">
                  <input id="password" name="cust_pwd" pattern="[A-Za-z]{2,}" title="Invalid Password" type="text" class="validate" data-error="#e3" required>
              ...
              <div class="row">
                <div class="input-field col s12">
                  <select id="country" name="cust_country" class="validate" data-error="#e4" required>    
               ...
               <div class="row">
                <div class="input-field col s12">
                  <input id="city" name="cust_city" type="text" class="validate" data-error="#e5">
              ...
              <div class="row">
                <div class="input-field col s12">
                  <textarea pattern=".{1,}" title="One or more characters" id="address" name="cust_complaint" class="materialize-textarea" data-error="#e4" required></textarea>
